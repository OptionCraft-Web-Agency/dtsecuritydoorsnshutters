...
const AboutUsInfo: React.FC = () => {
  ...
  return (
    <div style={containerStyle}>
      <p style={paragraphStyle}>About Us</p>
      <p style={descriptionStyle}>
        At DT Security Doors & Shutters, client satisfaction is at the heart of
        everything we do. We understand that true client happiness goes beyond
        just offering a product; it&apos;s about providing a solution that
        brings security and elegance to your home. With a dedication to
        exceptional craftsmanship and personalized service, we ensure every
        product from security doors to plantation shutters meets your specific
        needs. Reflecting on our journey, we&apos;ve evolved from focusing
        solely on steel doors to offering a comprehensive range of home safety
        solutions in Melbourne. Our expanded offerings include premium quality
        security doors, versatile blinds, fly screens, and elegant awnings,
        tailored to enhance the safety and style of your living space.
      </p>
      ...
      <button
        ...
        onMouseEnter={(e) =>
          (e.currentTarget.style.cssText =
            convertStyleToString(hoverButtonStyle))
        }
        onMouseLeave={(e) =>
          (e.currentTarget.style.cssText = convertStyleToString(buttonStyle))
        }
      >
        Contact Us
      </button>
