...
const Info1: React.FC = () => {
  ...
  return (
    <div style={containerStyle}>
      <p style={titleStyle}>
        Maximize Comfort and Security with Diverse Roller Shutters Operation Modes
      </p>
      <p style={subtitleStyle}>
        Choose an operation style that aligns with your home&apos;s design and your convenience needs
      </p>
      ...
      <div style={flexContainerStyle}>
        ...
        <div style={itemStyle}>
          <div style={{ display: "flex", flexDirection: "row", alignItems: "center", marginBottom: "20px" }}>
            <div style={imageContainerStyle}>
              <img src="/RollerDoor2.jpg" style={{ width: "100%", height: "auto" }} alt="Strap Coiler System" />
            </div>
            <div style={{ display: "flex", flexDirection: "column", marginLeft: "10px" }}>
        ...
        <div style={itemStyle}>
          <div style={{ display: "flex", flexDirection: "row", alignItems: "center", marginBottom: "20px" }}>
            <div style={imageContainerStyle}>
              <img src="/RollerDoor3.jpg" style={{ width: "100%", height: "auto" }} alt="Electric Switch" />
            </div>
            <div style={{ display: "flex", flexDirection: "column", marginLeft: "10px" }}>
        ...
        <div style={itemStyle}>
          <div style={{ display: "flex", flexDirection: "row", alignItems: "center", marginBottom: "20px" }}>
            <div style={imageContainerStyle}>
              <img src="/RollerDoor4.jpg" style={{ width: "100%", height: "auto" }} alt="Remote Control" />
            </div>
            <div style={{ display: "flex", flexDirection: "column", marginLeft: "10px" }}>
