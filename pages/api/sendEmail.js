...
async function sendEmail(req, res) {
  ...
  const mailOptions = {
    from: `None Reply`, // This should be the same email as your auth.user email
    to: `${email} ,dtmdgroup@outlook.com.au`, // The email that will receive the contact form data
