...
import Blinds1 from '../public/Blinds1.jpg';
import SecurityDoor1 from '../public/SecurityDoor1.jpg';
import Window1 from '../public/Window1.jpg';
    ...
    <>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: '1.5vw' }}>Secure and Beautify Your Home with XYZ Company</p>
            <p style={{ fontSize: '1vw' }}>Expert Craftsmanship in Security Doors, Blinds, Flyscreens, and More</p>
          </div>
      ...
      <div>
        ...
        <div>
          <div
            style={{
              backgroundImage: `url(${RollerDoor1})`,
          ...
          <div
            style={{
              backgroundImage: `url(${SecurityDoor1})`,
              backgroundSize: 'cover', // Optional: Adjust how the image covers the div
              backgroundPosition: 'center', // Optional: Adjust the position of the image
              height: '200px', // Set the height as needed
              width: '100%' // Set the width as needed
